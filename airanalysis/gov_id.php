...
$expand="expand";
$a = "$";
$url ="https://sta.ci.taiwan.gov.tw/STA_AirQuality_EPAIoT/v1.0/Datastreams?".$a."expand=Thing,Observations(".$a."orderby=phenomenonTime%20desc;".$a."top=1)&".$a."filter=Thing/properties/city%20eq%20%27%E5%98%89%E7%BE%A9%E5%B8%82%27%20&".$a."count=true";
$index = array();
$geojson = array();
