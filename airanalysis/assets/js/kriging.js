...
var kriging = function() {
    ...
    // Plotting on the DOM
    kriging.plot = function(canvas, grid, xlim, ylim, colors,multi) {
	// Clear screen 
	...
	for(i=0;i<n;i++)
		...
		z = (grid[i][j]-grid.zlim[0]);
		if(z<0.0) z =-z*0.34;
		// if (z>=0.0 && z<14.5){what_color=Math.floor(z*0.65);}
		// else if (z>=14.5 && z<35 ) what_color =Math.floor(z*0.65);
		// else if (z>=35 && z<54) what_color =Math.floor(z*0.55);
		// else if (z>= 54 && z<150) what_color=Math.floor(z*0.26);
		// else if (z>=150 && z<251) what_color=Math.floor(z*0.2);
		// else if (z>=251 )
		// if (z>=0 && z<4) what_color=0;
		// else if (z<=4 && z<8) what_color=1;
		// else if (z>=8 && z<12) what_color=2;
		// else if (z>=12 && z<15) what_color=3;
		// else if (z>=15 && z<20) what_color=4; //黃
		// else if (z>=20 && z<25) what_color=5;
		// else if (z>=25 && z<30) what_color=6;
		// else if (z>=30 && z<35) what_color=7;//橘
		// else if (z>=35 && z<40) what_color=8;
		// else if (z>=40 && z<45) what_color=9;
		// else if (z>=45 && z<50) what_color=10;
		// else if (z>=50 && z<64) what_color=11; //洪
		// else if (z>=64 && z<94) what_color=12;
		// else if (z>=94 && z<124) what_color=13;
		// else if (z>=124 && z<150) what_color=14;
		// else if (z>=150 )	what_color=15;

		
		
		// if(z>1.0) z = 1.0;
what_color=Math.floor(z*multi);
if (z >250) {what_color= colors.length-1;
}
else if (z <=250 &&what_color==41 ) what_color = colors.length-2;
// console.log(colors[what_color-1]);
// console.log("range:"+z);
// console.log("顏色"+Math.floor((colors.length-1)*z));
		ctx.fillStyle = colors[what_color-1];
		// ctx.fillStyle = colors[what_color];
